...
Let a,b,c,d,u,v,w,x,y,z denote objects.
Let X, Y, Z denote sets.
Let x \in X stand for x is an element of X.
Let R,S,T denote relations.

Signature Reduct.  A successor of x in R is an object.

Let x -R> y stand for y is a successor of x in R.
